`define OPCODE  IR[31:27]   // opcode
`define rds     IR[26:22]   // destination register
`define rsl     IR[21:17]   // source register #1
`define IMM_OP  IR[16]      // IR[16]==1 when source #2 is immediate operand
`define rs2     IR[15:11]   // source register #2
`define rst     IR[26:22]   // source register for store operation
